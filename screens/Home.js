        ...
        <SafeAreaView className="flex flex-1">
          <View style={{ height: "7%" }} className="mx-4 relative z-50">
            ...
            {locations.length > 0 && showSearchBar ? (
              <View className=" w-full bg-gray-300  rounded-3xl top-2 ">
                {locations.map((loc, index) => {
                  let checkBottom = index + 1 != locations.length;
                  let showBorder = checkBottom
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      key={index}
                      className={
                        "flex-row items-center border-0 p-3 px-4 mb-1 z-50" +
                        showBorder
                      }
                    >
                      <MapPinIcon size="20" marginRight={5} color="gray" />
          ...
          {/*forecast section  */}
          <View className="mx-4 flex justify-around flex-1 top-4 mb-2">
